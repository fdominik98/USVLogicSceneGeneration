...
six_vessel_interactions = [
        F4EnvironmentDesc(1, [OS, TS1, TS2, TS3, TS4, TS5],
        ...
        F4EnvironmentDesc(2, [OS, TS1, TS2, TS3, TS4, TS5],
        ...
        F4EnvironmentDesc(3, [OS, TS1, TS2, TS3, TS4, TS5],
                [RelationDesc(TS1, [crossing_init()], OS),
        ...
        F4EnvironmentDesc(4, [OS, TS1, TS2, TS3, TS4, TS5],
        ...
        F4EnvironmentDesc(5, [OS, TS1, TS2, TS3, TS4, TS5],
                [RelationDesc(TS1, [crossing_init()], OS),
                RelationDesc(OS, [head_on_init()], TS2),
                RelationDesc(TS3, [head_on_init()], OS),
                RelationDesc(OS, [crossing_init()], TS4),
        ...
        F4EnvironmentDesc(6, [OS, TS1, TS2, TS3, TS4, TS5],
        ...
        F4EnvironmentDesc(7, [OS, TS1, TS2, TS3, TS4, TS5],
                [RelationDesc(TS1, [overtaking_init()], OS),
                RelationDesc(OS, [overtaking_init()], TS2),
         ...
         F4EnvironmentDesc(8, [OS, TS1, TS2, TS3, TS4, TS5],
                [RelationDesc(TS1, [overtaking_init()], OS),
         ...
         F4EnvironmentDesc(9, [OS, TS1, TS2, TS3, TS4, TS5],
         ...
         F4EnvironmentDesc(10, [OS, TS1, TS2, TS3, TS4, TS5],
                [RelationDesc(TS1, [crossing_init()], OS),
                RelationDesc(TS2, [head_on_init()], OS),
                RelationDesc(TS3, [crossing_init()], OS),
                RelationDesc(OS, [crossing_init()], TS4),
