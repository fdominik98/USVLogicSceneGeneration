...
from model.environment.functional_models.model_utils import TS1, TS2, TS3

four_vessel_interactions = generate_models(F2EnvironmentDesc, [TS1, TS2, TS3], lambda: [AtVis(), AnyColregBear()])