...
from model.environment.usv_environment_desc import F4AbstractEnvironmentDesc, F4EnvironmentDesc, USVEnvironmentDesc
...
def generate_abstract_models(objects : List[VesselDesc]) -> List[USVEnvironmentDesc]:
    ...
    for i, clause in enumerate(clauses):
        ...
        models.append(F4EnvironmentDesc(i+1, [_OS] + objects, [RelationDescClause(rel_descs)]))
