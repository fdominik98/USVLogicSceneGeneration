...
class CenteredAngleCircleComponent(AngleCircleComponent):
    ...
    def do_draw(self, zorder : int):
        ...
        angle1_bow = np.degrees(self.center_vessel.heading + BOW_ANGLE / 2)
        angle2_bow = np.degrees(self.center_vessel.heading - BOW_ANGLE / 2)
    ...
    def do_update(self, new_env : USVEnvironment) -> List[plt.Artist]:
        ...
        self.wedge_stern.set_center(self.center_vessel.p)
        ...
        self.wedge_bow.set_center(self.center_vessel.p)
        ...
        self.wedge_masthead.set_center(self.center_vessel.p)
        ...
        self.update_one(self.center_vessel)
        return self.graphs