...
class VOConeComponent(PlotComponent):
    def __init__(self, ax : plt.Axes, scenario : MultiLevelScenario) -> None:
        ...
        self.other_velocity_graphs : Dict[Tuple[ConcreteActor, ConcreteActor], plt.Quiver] = {}
    ...
    def do_draw(self):
        ...
        for actor1, actor2 in self.scenario.concrete_scene.all_vessel_pair_combinations_with_obstacles:
            ...
            line1, = self.ax.plot([props.val2.v[0] + props.val1.x, cone1[0]], [props.val2.v[1] + props.val1.y, cone1[1]], '--', color=colors[actor2.id], linewidth=0.7, zorder=self.zorder)
            line2, = self.ax.plot([props.val2.v[0] + props.val1.x, cone2[0]], [props.val2.v[1] + props.val1.y, cone2[1]], '--', color=colors[actor2.id], linewidth=0.7, zorder=self.zorder)
            ...
            other_velocity = self.ax.quiver(props.val1.x, props.val1.y, props.val2.v[0], props.val2.v[1], angles='xy', scale_units='xy', scale=1, color=colors[actor2.id], zorder=self.zorder-10)
            ...
            filling = self.ax.fill([props.val2.v[0] + props.val1.x, cone1[0], cone2[0]],
                        ...
                        color=colors[actor2.id], alpha=0.15, zorder=self.zorder)
