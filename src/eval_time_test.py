...
ga_config = EvaluationData(population_size = 10, num_parents_mating = 2,
                        mutate_eta = 20, mutate_prob = 1, crossover_eta=15,
                        crossover_prob=1, timeout=TIMEOUT, init_method=INIT_METHOD, random_seed=RANDOM_SEED)

nsga_config = EvaluationData(population_size = 10, mutate_eta = 20, mutate_prob = 1,
                            crossover_eta=15, crossover_prob=1, timeout=TIMEOUT,
                            init_method=INIT_METHOD, random_seed=RANDOM_SEED)

pso_config = EvaluationData(population_size = 10, c_1=1.5, c_2=1.5, w=0.7, timeout=TIMEOUT,
                          init_method=INIT_METHOD, random_seed=RANDOM_SEED)

de_config = EvaluationData(population_size = 10, mutate_prob = 1, crossover_prob=1,
...
tests : List[GeneticAlgorithmBase] = [
    ...
    PyMooNSGA2Algorithm(measurement_name='test_3_vessel_scenarios', env_configs=three_vessel_interactions, test_config=nsga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    ...
    PyGadGAAlgorithm(measurement_name='test_4_vessel_scenarios', env_configs=four_vessel_interactions, test_config=ga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    PyMooNSGA2Algorithm(measurement_name='test_4_vessel_scenarios', env_configs=four_vessel_interactions, test_config=nsga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    ...
    PyGadGAAlgorithm(measurement_name='test_5_vessel_scenarios', env_configs=five_vessel_interactions, test_config=ga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    PyMooNSGA2Algorithm(measurement_name='test_5_vessel_scenarios', env_configs=five_vessel_interactions, test_config=nsga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    ...
    PyGadGAAlgorithm(measurement_name='test_6_vessel_scenarios', env_configs=six_vessel_interactions, test_config=ga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
    PyMooNSGA2Algorithm(measurement_name='test_6_vessel_scenarios', env_configs=six_vessel_interactions, test_config=nsga_config,
                        number_of_runs=NUMBER_OF_RUNS, warmups=WARMUPS, verbose=False),
