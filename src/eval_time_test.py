...
algos = {
    ...
    5 : PyMooAlgorithm(measurement_name='evaluation_time_test_before_safety_distance', config_name='six_vessel_colreg_scenario', verbose=False, random_init=True, runtime=90),
}
