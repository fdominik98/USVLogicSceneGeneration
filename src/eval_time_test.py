...
test_config1 = EvaluationData(population_size = 10, num_parents_mating = 2,
                        ...
                        crossover_prob=1, timeout=TIMEOUT, init_method='uniform', random_seed=RANDOM_SEED)


tests = [
    PyMooNSGA2Algorithm(measurement_name='Test_3_vessel_scenarios', env_configs=three_vessel_interactions, test_config=test_config1,
