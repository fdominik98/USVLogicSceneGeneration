...
from utils.evaluation_config import NUMBER_OF_RUNS, VERBOSE, WARMUPS, nsga2_vessel_sb_o_config, scenic_rs_o_config, scenic_rs_msr_config, nsga2_vessel_sb_msr_config, nsga3_vessel_sb_msr_config,  nsga3_vessel_sb_o_config
...
measurements : List[Tuple[str, List[Scenario], EvaluationData]] = [
    # SB-O
    (f'{base_name}_2_vessel_0_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(2, 0), nsga3_vessel_sb_o_config),
    (f'{base_name}_2_vessel_1_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(2, 1), nsga3_vessel_sb_o_config),
    (f'{base_name}_3_vessel_0_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(3, 0), nsga3_vessel_sb_o_config),
    (f'{base_name}_3_vessel_1_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(3, 1), nsga3_vessel_sb_o_config),
    (f'{base_name}_4_vessel_0_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(4, 0), nsga3_vessel_sb_o_config),
    (f'{base_name}_5_vessel_0_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(5, 0), nsga3_vessel_sb_o_config),
    (f'{base_name}_6_vessel_0_obstacle_scenarios', LogicalModelManager.get_x_vessel_y_obstacle_scenarios(6, 0), nsga3_vessel_sb_o_config),
    
    # SB-MSR
    (f'{base_name}_2_vessel_0_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(2, 0), nsga3_vessel_sb_msr_config),
    (f'{base_name}_2_vessel_1_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(2, 1), nsga3_vessel_sb_msr_config),
    (f'{base_name}_3_vessel_0_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(3, 0), nsga3_vessel_sb_msr_config),
    (f'{base_name}_3_vessel_1_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(3, 1), nsga3_vessel_sb_msr_config),
    (f'{base_name}_4_vessel_0_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(4, 0), nsga3_vessel_sb_msr_config),
    (f'{base_name}_5_vessel_0_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(5, 0), nsga3_vessel_sb_msr_config),
    (f'{base_name}_6_vessel_0_obstacle_scenarios', FunctionalModelManager.get_x_vessel_y_obstacle_scenarios(6, 0), nsga3_vessel_sb_msr_config),
