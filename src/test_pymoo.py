...
alg = PyMooAlgorithm(measurement_name='test', config_name='five_vessel_colreg_scenario_non_ambigious', verbose=True, random_init=True, runtime=20)

data = alg.evaluate(population_size=10, mutate_prob=0.5, crossover_prob=1, num_parents_mating=2,
             number_of_generations=None, random_seed=1234, mutate_eta=15,crossover_eta=20)
