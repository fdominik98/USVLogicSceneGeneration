...
from model.colreg_situation import Relation, HeadOn, NoColreg
...
class VesselNode():
    def __init__(self, vessel: Vessel) -> None:
        self.vessel = vessel
        self.colreg_situations : List[Relation] = []  
        self.in_degree = 0
        self.out_degree = 0      
...
class VesselOrderGraph():
    def __init__(self, colreg_situations : List[Relation]):
    ...
    def add_nodes(self, colreg_s : Relation):
    ...
    def add_edge(self, colreg_s : Relation):
