...
ts_infos = create_scenario(ts_num=5)
...
ts5, prop5 = ts_infos[4]
require prop5.check_constraints()
...
prop_ts_7 = new NoCollideOutVisProps with val1 ts5, with val2 ts1
require prop_ts_7.check_constraints()
prop_ts_8 = new NoCollideOutVisProps with val1 ts5, with val2 ts2
require prop_ts_8.check_constraints()
prop_ts_9 = new NoCollideOutVisProps with val1 ts5, with val2 ts3
require prop_ts_9.check_constraints()
prop_ts_10 = new NoCollideOutVisProps with val1 ts5, with val2 ts4
require prop_ts_10.check_constraints()
