...
- `common_ocean_scenarios/`: All gathered scenarios from https://commonocean.cps.cit.tum.de/ in the CommonOcean xml format.
...
#### `src/commonocean/`
CommonOcean source code for parsing AIS scenarios. https://commonocean.cps.cit.tum.de/.
